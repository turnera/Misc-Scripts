...
{
    markers = place;
    var position = new google.maps.LatLng(markers.latitude, markers.longitude);
    ...
    marker.addListener('click', function() {
        ...
        $.getJSON('/articles?geo=' + place.postal_code, function success(data)
        {
        "<ul>";
            for (var key in data[0])
            {
                if(!info)
                {
                    info = "<li>" + "<a href=" + data[0][key].link + ">" + data[0][key].title + "</a>" + "</li>";
                }
                else
                {
                    info += "<li>" + "<a href=" + data[0][key].link + ">" + data[0][key].title + "</a>" + "</li>";
